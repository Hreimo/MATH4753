#' @title Max Likelihood Estimator for Normal
#'
#' @param x the sample size
#' @param mu the values for the mean to be tested
#' @param sig the values for the standard deviation to be tested
#' @param ... A filler parameter to add to the title of the plots, in this case
#' @importFrom graphics 'contour'
#' @importFrom stats 'sd'
#' @return A graphical estimate for both mu and sigma
#' @export
#'
